...
#define X_BED_SIZE 250  // should be 220 but we get "RIGHT_PROBE_BED_POSITION is outside the probe region." error
...
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS 250  // this should be X_BED_SIZE + 30, but we get error above
